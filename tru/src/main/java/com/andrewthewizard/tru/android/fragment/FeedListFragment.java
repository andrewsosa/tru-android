...
import com.andrewthewizard.tru.android.ModelTools;
...
public class FeedListFragment extends Fragment {
    ...
    public static FeedListFragment newInstance(@Nullable Object object) {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // Adapt our things
        ArrayList<MessageModel> dummy = new ArrayList<>();
        mAdapter = new FeedListAdapter(dummy);
    ...
    public class FeedListAdapter extends RecyclerView.Adapter<MessageVH> {

        ArrayList<MessageModel> mDataset;

        public FeedListAdapter(ArrayList<MessageModel> dataset) {
            super();
            mDataset = dataset;
        }
        ...
        public MessageVH onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.tile_message, parent, false);
            // set the view's size, margins, paddings and layout parameters
            MessageVH vh = new MessageVH(v);
            return vh;
        }
        ...
        public void replaceDataset(ArrayList<MessageModel> dataset) {
            mDataset = dataset;
        }
    }
...
//            String userID = new Firebase(Tru.FIREBASE_URL).getAuth().getUid();
...
//                                        public void run() {
//
//                                            Firebase target = new Firebase(Tru.FIREBASE_URL)
//                                                    .child("feed")
//                                                    .child(ref.getKey());
//
...
//    }
    ...
    /* Temporary removing swiping features
    ...
    public class MessageTouchCallbacks extends ItemTouchHelper.SimpleCallback {
        ...
        public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
            ...
            try {
                mAdapter.getRef(viewHolder.getAdapterPosition()).child("hidden").child(new Firebase(Tru.FIREBASE_URL).getAuth().getUid()).setValue(true);
            } catch (Exception e) {
                Log.e("Tru", "Someone did the TJ thing");
            }
        }
